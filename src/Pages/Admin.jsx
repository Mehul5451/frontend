...
const AdminPanel = () => {
  ...
  const fetchDJs = async () => {
    try {
      const response = await axios.get("http://localhost:5000/dj");
  ...
  const handleAddDJ = async () => {
    try {
      const response = await axios.post("http://localhost:5000/dj", newDJ);
  ...
  const handleDeleteDJ = async (id) => {
    try {
      await axios.delete(`http://localhost:5000/dj/${id}`);
  ...
  const handleAddEvent = async () => {
    ...
    try {
      const response = await axios.post("http://localhost:5000/events", eventPayload, {
        headers: {
  ...
  useEffect(() => {
    const fetchTicketBookings = async () => {
      try {
        ...
        const response = await axios.get("http://localhost:3000/ticket-bookings", {
          headers: {
  ...
  const handleTicketAction = async (id, status) => {
    try {
      ...
      const response = await axios.put(
        `http://localhost:3000/ticket-bookings/${id}`,
  ...
  const handleDeleteTicketBooking = async (id) => {
    try {
      ...
      await axios.delete(`http://localhost:3000/ticket-bookings/${id}`, {
        headers: {
